...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      <?php
      	$PHPConfigFactory = new PHPConfigFactory('http://localhost/AppMenuBuilder');
        $menuList = $PHPConfigFactory->build(SAI_APPMENUBUILDER_PATH . 'test' . DS . 'samples' . DS . 'phpConfigSampleMenu.php');
        $AdminLTEBuilder = new AdminLTEBuilder('http://localhost/AppMenuBuilder/sample/AdminLteMenu.php');
        echo $AdminLTEBuilder->build($menuList);
...
<!-- Sparkline -->
<script src="../bower_components/admin-lte/plugins/sparkline/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
