...
class SimpleBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->simpleBuilder = new SimpleBuilder('http://localhost/AppMenuBuilder');
    ...
    {
        $itemList = $this->phpConfigFactory->build($this->phpConfig);
        $menu = $this->simpleBuilder->build($itemList, '', 'parentClass', 'childClass', 'activeClass');
        $this->assertEquals('<ul class="sidebar-menu"><li class="" ><a href="http://localhost/AppMenuBuilder/level1"><i class="fa-dashboard"></i><span> Level 1</span></a></li><li class="parentClass " ><a href="http://localhost/AppMenuBuilder/level2"><i class="fa-adjust"></i><span> Level 2</span><i class="fa fa-angle-left pull-right"></i></a><ul class="childClass"><li class="" ><a href="#baseurl#level2.1"><i class="fa-circle-o"></i><span> Level 2.1</span></a></li><li class="" ><a href="#baseurl#level2.2"><i class="fa-circle-o"></i><span> Level 2.2</span></a></li><li class="" ><a href="#baseurl#level2.3"><i class="fa-circle-o"></i><span> Level 2.3</span></a></li></ul></li><li class="parentClass " ><a href="http://localhost/AppMenuBuilder/level2"><i class="fa-adjust"></i><span> Level 2</span><i class="fa fa-angle-left pull-right"></i></a><ul class="childClass"><li class="parentClass " ><a href="#baseurl#level3.1"><i class="fa-circle-o"></i><span> Level 3.1</span><i class="fa fa-angle-left pull-right"></i></a><ul class="childClass"><li class="" ><a href="#baseurl#level3.1.1"><i class="fa-circle-o"></i><span> Level 3.1.1</span></a></li><li class="" ><a href="#baseurl#level3.1.2"><i class="fa-circle-o"></i><span> Level 3.1.2</span></a></li></ul></li></ul></li></ul>', $menu);
    }
}
